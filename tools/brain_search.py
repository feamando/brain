...
class BrainSearch:
    ...
    def __init__(self, brain_path: Optional[Path] = None, registry: Optional[Dict] = None):
    ...
    def _merge_results(self, alias_results: List[SearchResult],
                       content_results: List[SearchResult]) -> List[SearchResult]:
    ...
    def _build_synonym_dict(self) -> Dict[str, List[str]]:
        ...
        raw_synonyms = {
            ...
            'tpt': ['wellness-platform', 'well-platform', 'wellplat'],
            'ff': ['growth-initiative', 'growthinitiativ'],
