...
def get_github_config() -> dict:
    ...
    return {
        ...
        'org': config.get("integrations.github.org") or os.getenv("GITHUB_ORG", "example-org")
    }
...
def get_product_ids() -> List[str]:
    ...
    Returns:
        List of product ID strings (e.g., ['mobile-app', 'wellness-platform'])
    """
...
def get_product_by_id(product_id: str) -> Optional[dict]:
    ...
    Args:
        product_id: Product identifier (e.g., 'mobile-app')
