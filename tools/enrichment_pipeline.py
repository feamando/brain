...
class EnrichmentPipeline:
    ...
    def __init__(
        ...
        self.checkpoint_file = checkpoint_file or brain_path / ".enrichment_checkpoint.json"
    ...
    def run(
        ...
        if resume and self.checkpoint_file.exists():
            ...
            print(f"Resuming from checkpoint: {self.progress.processed_entities}/{self.progress.total_entities}")
        else:
    ...
    def _load_source_data(self, source: str) -> List[Dict[str, Any]]:
        ...
        if not data_dir.exists():
            ...
            alt_paths = {
                ...
                "slack": self.brain_path.parent / "brain" / "Inbox" / "Slack" / "Messages",
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Run Brain enrichment pipeline"
    )
    parser.add_argument(
        "--brain-path",
        type=Path,
    ...
    parser.add_argument(
        "--sources",
        nargs="+",
        choices=["gdocs", "slack", "jira", "github", "context"],
