...
class ContextEnricher(BaseEnricher):
    ...
    def enrich(self, item: Dict[str, Any], dry_run: bool = False) -> int:
        ...
        for entity_slug in mentioned_entities:
            ...
            updates = self._generate_updates(
                entity_slug, context_data, date, content
            )
    ...
    def _extract_context_data(self, content: str) -> Dict[str, Any]:
        ...
        for line in lines:
            ...
            elif "action item" in line_lower or "todo" in line_lower or "next step" in line_lower:
    ...
    def _generate_updates(
        ...
        mention_count = sum(
            content.lower().count(v.lower()) for v in slug_variants
        )
        if mention_count > 0:
