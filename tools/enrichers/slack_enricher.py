...
class SlackEnricher(BaseEnricher):
    ...
    def _analyze_sentiment(self, text: str) -> str:
        ...
        positive_words = [
            "great", "awesome", "perfect", "excellent", "thanks",
            "good job", "nice", "love", "excited", "shipped"
        ]
        negative_words = [
            "issue", "problem", "bug", "broken", "failed",
            "blocked", "stuck", "urgent", "critical", "wrong"
        ]
