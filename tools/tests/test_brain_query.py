...
class TestBrainQuery:
    ...
    def test_brain_graph_query(self):
        ...
        bq = BrainQuery()
        result = bq.query("growth initiative", limit=10, use_graph=True)
...
class TestQueryDependence:
    ...
    def test_different_queries_different_results(self):
        ...
        result2 = bq.query("growth initiative canada", limit=10, use_graph=False)
...
class TestPerformance:
    ...
    def test_search_latency(self):
        ...
        # Measure
        start = time.time()
        result = bq.query("growth initiative", limit=10, use_graph=False)
