...
Main entry point for querying the Brain knowledge base.
...
Usage:
    python -m pmos_brain.core.query "query string"
    python -m pmos_brain.core.query "project launch" --no-graph
    python -m pmos_brain.core.query "mobile app" --format json --limit 5
"""
...
from pmos_brain.core.search import BrainSearch, SearchResult
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python -m pmos_brain.core.query "project launch"
  python -m pmos_brain.core.query "mobile app" --no-graph
  python -m pmos_brain.core.query "engineering team" --format json
  python -m pmos_brain.core.query "team lead" --limit 5 --decay 0.3
        """,
    )
