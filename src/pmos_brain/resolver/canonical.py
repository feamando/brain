...
class CanonicalResolver:
    ...
    def invalidate_cache(self):
        """Remove the cache file to force a rebuild on next use."""
...
def main():
    ...
    # Default brain path: use provided path or current working directory
    brain_path = Path(args.brain_path) if args.brain_path else Path.cwd()

    resolver = CanonicalResolver(brain_path)
