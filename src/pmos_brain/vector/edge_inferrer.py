#!/usr/bin/env python3
"""
Brain Embedding-Based Edge Inferrer

Infers 'similar_to' relationships from embedding similarity
to increase graph density.

Usage:
    python3 edge_inferrer.py scan            # Find potential edges
    python3 edge_inferrer.py apply           # Apply edges to entities
    python3 edge_inferrer.py --threshold 0.8 # Custom similarity threshold
    python3 edge_inferrer.py --dry-run       # Preview without applying
"""
